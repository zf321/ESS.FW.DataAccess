...
namespace ESS.FW.DataAccess
{
    ...
    [Component(LifeStyle.Transient, ModuleLevel.Normal, Interceptor.Log | Interceptor.Caching | Interceptor.Measure  )]
    public abstract partial class BaseRepository<TEntity,TKey> : IRepository<TEntity, TKey> where TEntity : class, new()
    {
        ...
        ////[Caching(CachingMethod.Put)]
        public virtual TEntity Update(TEntity entity, string[] childMap = null)
        {
            return entity;
        }
        ////[Caching(CachingMethod.Put)]
        ...
        public virtual void BulkSaveEntityForType() { }
