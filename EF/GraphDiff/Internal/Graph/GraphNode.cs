...
//namespace ESS.FW.DataAccess.EF.GraphDiff.Internal.Graph
//{
...
//        public readonly PropertyInfo Accessor;
...
//        protected static void AttachCyclicNavigationProperty(DbContext context, object parent, object child)
//        {
//            if (parent == null || child == null) return;

//            var parentType = context.Model.FindEntityType(parent.GetType());
//            var childType = context.Model.FindEntityType(child.GetType());

//            var navigationProperties = context.GetNavigationPropertiesForType(childType.ClrType);

//            var parentNavigationProperty = navigationProperties
//                    .Where(navigation => navigation..EdmType.Name == parentType.Name)
...
//        private static void EnsureConcurrency<T>(DbContext db, T entity1, T entity2)
//        {
